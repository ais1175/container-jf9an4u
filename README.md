...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-jf9an4u.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-jf9an4u.containers.anotherwebservice.com/
...
```
git clone git@github.com:ais1175/container-jf9an4u.git
cd container-jf9an4u
```
...
```
docker attach container-jf9an4u
```
